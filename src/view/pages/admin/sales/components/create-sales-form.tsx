            ...
            return (
              <div key={field.id} className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className={`${index === 0 ? 'hidden' : ''} mt-6 h-12 w-10 rounded-[10px] border border-rose-500 text-white transition-all duration-150 ease-linear hover:cursor-pointer hover:bg-rose-50`}
                >
